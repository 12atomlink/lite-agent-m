...
describe("revert on non-git project", () => {
  test("revert returns session unchanged when worktree is /", async () => {
    ...
    await Instance.provide({
      ...
      fn: async () => {
        ...
        // revert should return session without crashing or modifying files
        ...
        // revert field should be undefined (no snapshot taken)
