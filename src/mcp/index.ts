...
export namespace MCP {
  ...
  export async function authenticate(mcpName: string): Promise<Status> {
    ...
    // HTTP service: no browser available, emit event so HTTP layer can forward URL to client
    log.warn("no browser available, emitting event for manual OAuth", { mcpName, url: authorizationUrl })
